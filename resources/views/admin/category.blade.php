                            ...
                            <div id="editModal-{{ $cat->id }}" class="hidden">
                                <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
                                    <div class="bg-white rounded-xl shadow-lg w-full max-w-md p-6 relative">
                                        ...
                                        <form action="{{ route('editAdminCategory', $cat->id) }}" method="POST" class="space-y-4">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div>
                                                ...
                                                <select name="parent_id" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-blue-500 focus:border-blue-500">
