                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <button type="button" wire:click="setCategory('All')"
                        class="px-4 py-2 rounded-full text-sm font-medium transition-all
                            {{ $selectedCategory === 'All' ? 'bg-brand-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }}">
                        All
                    </button>
            ...
            <div class="mt-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <select wire:model="sortBy" id="sort"
                        class="border border-gray-300 rounded-lg px-3 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500">
