        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white border border-gray-100 rounded-lg p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <label
                                class="flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:border-brand-600 transition-all {{ $payment_method === 'card' ? 'border-brand-600 bg-brand-50' : '' }}">
                            ...
                            <label
                                class="flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:border-brand-600 transition-all {{ $payment_method === 'upi' ? 'border-brand-600 bg-brand-50' : '' }}">
                                <input type="radio" wire:model.live="payment_method" value="upi"
                                    class="text-brand-600 focus:ring-brand-600">
                                <div class="ml-3">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white border border-gray-100 rounded-lg p-6 sticky top-8">
                    ...
                    <!-- Coupon Code -->
                    <div class="mt-4">
                        <div class="text-sm font-maedium mb-2">Coupon Code</div>
                        <div class="flex">
