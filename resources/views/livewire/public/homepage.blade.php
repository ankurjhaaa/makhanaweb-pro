<div class="bg-white text-gray-800">
    <!-- Hero -->
    <section class="max-w-7xl mx-auto px-4 sm:px-6 py-12 md:py-20 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
        <div>
            ...
            <p class="mt-6 text-gray-600 text-lg leading-relaxed">
                Direct from Nature — Premium makhana, authentic spices, and natural snacks that nourish your body and delight your taste buds.
            </p>
            ...
            <div class="mt-8 flex flex-wrap gap-4">
                ...
                <a href="#" class="border-2 border-brand-600 text-brand-600 px-6 py-3 rounded-full hover:bg-brand-50 transition-all font-medium">
                    Learn More
                </a>
            </div>
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 py-16 md:py-20">
        <div class="text-center">
            ...
            <p class="text-gray-600 mt-4 max-w-2xl mx-auto">Discover the incredible health benefits of this ancient superfood that's perfect for modern wellness</p>
        </div>

        <div class="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            <div class="bg-white p-6 border border-gray-100 rounded-lg text-center hover:border-brand-200 transition-all">
                ...
                <p class="text-gray-600 mt-3">Low in cholesterol and sodium, high in magnesium for cardiovascular health.</p>
            </div>
            <div class="bg-white p-6 border border-gray-100 rounded-lg text-center hover:border-brand-200 transition-all">
                <div class="inline-block p-3 bg-brand-50 rounded-full text-brand-600 text-3xl mb-4">⚡</div>
                <h4 class="font-poppins font-semibold text-xl">Energy Boost</h4>
                <p class="text-gray-600 mt-3">Rich in complex carbs that provide sustained energy without sugar spikes.</p>
            </div>
            <div class="bg-white p-6 border border-gray-100 rounded-lg text-center hover:border-brand-200 transition-all">
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 py-16">
        ...
        <p class="text-center text-gray-600 mt-2 max-w-2xl mx-auto">Fascinating insights about this remarkable superfood</p>
    ...
    <section class="bg-gray-50 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <p class="text-center text-gray-600 mt-2 max-w-2xl mx-auto">Food reviews from real people who love our products</p>
            ...
            <div class="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white p-6 rounded-lg border border-gray-100">
                    <div class="flex justify-between items-center">
                        ...
                        <div class="w-12 h-12 bg-brand-100 rounded-full flex items-center justify-center text-brand-600 font-poppins font-bold">PS</div>
                    </div>
                    <div class="text-yellow-400 mt-4">★★★★★</div>
                    <p class="text-gray-600 mt-3 leading-relaxed">"The makhana quality is exceptional! My kids love the roasted flavored ones. Will definitely order again."</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg border border-gray-100">
                    <div class="flex justify-between items-center">
                        ...
                        <div class="w-12 h-12 bg-brand-100 rounded-full flex items-center justify-center text-brand-600 font-poppins font-bold">RK</div>
                    </div>
                    <div class="text-yellow-400 mt-4">★★★★★</div>
                    <p class="text-gray-600 mt-3 leading-relaxed">"Best spices I've ever bought online. Authentic taste and aroma. Your's Snacks has become our go-to brand."</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg border border-gray-100">
                    <div class="flex justify-between items-center">
                        ...
                        <div class="w-12 h-12 bg-brand-100 rounded-full flex items-center justify-center text-brand-600 font-poppins font-bold">AP</div>
                    </div>
                    <div class="text-yellow-400 mt-4">★★★★★</div>
                    <p class="text-gray-600 mt-3 leading-relaxed">"I love the healthy snack options! Perfect for my family's wellness journey. Great packaging and fast delivery."</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white border-t border-gray-100">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 text-center">
            ...
            <p class="text-gray-600 mt-4 max-w-2xl mx-auto">Join thousands of satisfied customers who trust Your's Snacks for their daily nutrition needs.</p>
            <div class="mt-8 flex flex-wrap items-center justify-center gap-4">
                <a href="#" class="bg-brand-600 text-white px-8 py-4 rounded-full hover:bg-brand-700 transition-all font-medium">Shop All Products</a>
                <a href="#" class="border-2 border-brand-600 text-brand-600 px-8 py-4 rounded-full hover:bg-brand-50 transition-all font-medium">View Our Story</a>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div>
                    ...
                    <p class="text-gray-600 mt-4">Bringing pure, natural, and nutritious snacks to every home with quality sourced ingredients.</p>
                ...
                <div>
                    ...
                    <div class="mt-4">
                        <form class="flex flex-col space-y-3">
                            <input type="email" placeholder="Enter your email" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500">
                            <button type="submit" class="w-full bg-brand-600 text-white py-3 px-4 rounded-lg hover:bg-brand-700 transition-all font-medium">Subscribe</button>
                        </form>
                    </div>
                </div>
            </div>
