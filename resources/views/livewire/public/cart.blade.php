            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2">
                    <div class="border border-gray-100 rounded-lg overflow-hidden">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                                    ...
                                    <div class="col-span-1 md:col-span-6">
                                        <div class="flex items-center">
                                            ...
                                            <div class="md:hidden">
                                                <button type="button" wire:click="removeItem({{ $productId }})"
                                            ...
                                            <div class="h-20 w-20 ml-3 md:ml-0 bg-gray-100 rounded-md overflow-hidden">
                                                <img src="{{ asset('storage/' . $item['image']) }}"
                                                    alt="{{ $item['name'] ?? 'Product' }}" class="h-full w-full object-cover">

                                            </div>

                                            <!-- Product Details -->
                                            <div class="ml-4">
                                                <h3 class="font-poppins font-medium">{{ $item['name'] ?? 'Unknown Product' }}
                                                </h3>
                                                <div class="text-sm text-gray-500">{{ $item['category'] ?? 'General' }} •
                                                    {{ $item['weight'] ?? '' }}</div>
                                                <!-- Price (Mobile Only) -->
                                                <div class="mt-1 md:hidden">
                                                    <span class="text-brand-600 font-semibold">₹{{ $item['price'] ?? 0 }}</span>
                                                    @if(($item['originalPrice'] ?? 0) > ($item['price'] ?? 0))
                                                        <span
                                                            class="text-gray-400 text-xs line-through ml-1">₹{{ $item['originalPrice'] }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-span-1 md:col-span-2 md:text-center">
                                        <div
                                            ...
                                            <button type="button"
                                                wire:click="updateQuantity({{ $productId }}, {{ ($item['quantity'] ?? 1) - 1 }})"
                        ...
                        <div class="mt-6">
                            <a href="/shop"
                                class="inline-block text-brand-600 hover:text-brand-700 font-medium transition-all">
