                ...
                <form wire:submit="submitForm" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            wire:model="message"
                            rows="5"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors @error('message') border-red-500 @enderror"
                            placeholder="Tell us more about your inquiry..."
                        ></textarea>
                        @error('message')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-sm text-gray-500">{{ strlen($message) }}/1000 characters</p>
                    </div>
            ...
            <div class="space-y-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">
                                    <a href="tel:+919876543210" class="hover:text-orange-600 transition-colors">+91 98765 43210</a><br>
                                    <a href="tel:+912212345678" class="hover:text-orange-600 transition-colors">+91 22 1234 5678</a>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">
                                    <a href="mailto:hello@yourssnacks.com" class="hover:text-orange-600 transition-colors">hello@yourssnacks.com</a><br>
                                    <a href="mailto:support@yourssnacks.com" class="hover:text-orange-600 transition-colors">support@yourssnacks.com</a>
                                </p>
                            </div>
                        </div>
                ...
                <div class="bg-orange-50 border border-orange-200 rounded-xl p-6">
                    ...
                    <p class="text-sm text-orange-800">
                        For faster support, check our <a href="#" class="underline hover:no-underline">FAQ section</a> or WhatsApp us at 
